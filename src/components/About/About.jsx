    ...
    <>
      <section id="about">
        ...
        <div className="skills">
          <h1>About Me</h1>
          <p>
            I'm a frontend developer intern at Vica Web Solution, based in
            Homs, Syria. I love building clean, responsive, and interactive
            websites using technologies like HTML, CSS, JavaScript, and React.
            I'm passionate about creating smooth user experiences and always
            eager to learn new tools and frameworks. Currently, I'm studying
            Informatics Engineering at Al-Baath University and continuously
